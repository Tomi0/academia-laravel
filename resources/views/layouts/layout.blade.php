    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top scrolling-navba bg-faded" id="white-bg">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ route('pages.home') }}"><img src="img/logo.png" alt=""></a>
            </div>
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav mr-auto w-100 justify-content-end">
                    ...
                    @if(auth()->check())
                        ...
                        <li class="nav-item">
                            <form action="{{ route('logout') }}" method="POST">
                                ...
                                <button class="no-button"><a class="nav-link">Cerrar sesión</a></button>
                    ...
                    @else
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('pages.whyus') }}">Why us</a>
                        </li>
                        <li class="nav-item">
